...
| ID   | Date       | Decision                                                                                                                                   | Status                  | Canonical source                                                                                                                                 |
| ---- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| D031 | 2026-06-27 | Jun 29 demo runtime uses the Python `psql` bridge for synchronous plan/replan; TS orchestrator/worker remain unmounted target architecture | Accepted                | [ADR 0004](../docs/adr/0004-runtime-topology.md), [architecture-context.md](architecture-context.md), [spec 07](feature-specs/07-api-service.md) |
| D030 | 2026-06-25 | Layer 4 is no-go for the live demo; use the RCG-51 Layers 1-3 contingency runbook                                                          | Accepted                | [layer4-cut-contingency.md](../docs/demo/layer4-cut-contingency.md), [sprint-plan-jun24-29.md](../docs/meetings/sprint-plan-jun24-29.md)         |
...
| D031 | Current demo runtime uses the Python `psql` bridge for synchronous plan/replan; TS orchestrator/worker are not mounted. |
