...
| Val · Frontend                   | **GPFree landing merged** (PR #13); design system      | **Clerk Google-only auth** (`/sign-in`, middleware) + landing redesign (3D card) on `val/auth`; then demo shell + sidebar on mocks (RCG-27, RCG-24) | generated contracts for real payload wiring    |
