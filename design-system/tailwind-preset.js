  ...
  theme: {
    extend: {
      colors: {
        ...
        // Foreground (text/border) + `-bg` (fill) pair per state.
        'status-current': 'var(--status-current)',
        'status-current-bg': 'var(--status-current-bg)',
        'status-stale': 'var(--status-stale)',
        'status-stale-bg': 'var(--status-stale-bg)',
        'status-superseded': 'var(--status-superseded)',
        'status-superseded-bg': 'var(--status-superseded-bg)',
        'status-failed': 'var(--status-failed)',
        'status-failed-bg': 'var(--status-failed-bg)',
        'status-generating': 'var(--status-generating)',
        'status-generating-bg': 'var(--status-generating-bg)',
        'status-proposed': 'var(--status-proposed)',
        'status-proposed-bg': 'var(--status-proposed-bg)',
      },
      borderColor: {
      ...
      spacing: {
        ...
        24: 'var(--space-24)',
        32: 'var(--space-32)',
        // Semantic gap aliases (enable gap-xs…gap-xl, p-md, etc.)
        xs: 'var(--gap-xs)',
        sm: 'var(--gap-sm)',
        md: 'var(--gap-md)',
        lg: 'var(--gap-lg)',
